...
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'C2'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Young' AND FIRST_NAME='Judith'), '2020-01-01');
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'C1'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Ward' AND FIRST_NAME='Raymond'), '2020-01-02');
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'C3'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Williams' AND FIRST_NAME='Shawn'),'2020-06-08');
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'M2'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Wood' AND FIRST_NAME='Jose'), '2020-06-05');